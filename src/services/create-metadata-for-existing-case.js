...
export const createMetadataForExistingCase = async ({ authToken, crn, sbi, caseId, metadata, correlationId }) => {
    ...
    const { caseId, error: caseError } = await createMetadataForExistingCase({
        authToken,
        caseId,
        metadata: {
            ...metadata,
